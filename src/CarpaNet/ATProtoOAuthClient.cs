...
/// </summary>
public sealed class ATProtoOAuthClient : IDisposable
{
    ...
    public ATProtoOAuthClient(OAuthClientConfig config)
    {
    ...
    public async Task<OAuthSession> CallbackAsync(
        string callbackUrl,
        CancellationToken cancellationToken = default)
    {
        ThrowIfDisposed();
    ...
    public async Task<OAuthSession?> RestoreSessionAsync(
        string sub,
        CancellationToken cancellationToken = default)
    {
        ThrowIfDisposed();
