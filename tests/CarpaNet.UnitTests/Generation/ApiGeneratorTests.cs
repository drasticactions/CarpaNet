...
{
    [Fact]
    public void GenerateParametersClass_ArrayProperty_DoesNotUseDictionaryAdd()
    {
        ...
        // The generated return type must support repeated keys.
        Assert.Contains(
            "System.Collections.Generic.IEnumerable<System.Collections.Generic.KeyValuePair<string, string>>",
            generated);

        // It must NOT use a Dictionary, which would throw on duplicate Add.
        Assert.DoesNotContain("new System.Collections.Generic.Dictionary<string, string>", generated);
        Assert.DoesNotContain(
            "System.Collections.Generic.IReadOnlyDictionary<string, string> ToDictionary",
            generated);
    }
